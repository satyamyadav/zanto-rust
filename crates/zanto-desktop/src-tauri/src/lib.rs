...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            ipc::skills::read_skill,
            ipc::skills::save_skill,
            ipc::skills::delete_skill,
            ipc::skills::rename_skill,
            ipc::files::browse_dir,
            ipc::files::read_image_data_url,
            ipc::files::open_path,
            ipc::artifacts::store_document_artifact,
            ipc::artifacts::delete_stored_artifact,
